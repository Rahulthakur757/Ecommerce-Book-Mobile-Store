...
function AddPlaceForMobile() {
    ...
    function goToMobilePlaceList() {
        alert('ok cancel button')
    }
    function doAddPlace() {

        alert('ok add place book')
        let data = {
        ...
        axios({
            url: apiUrl + '/add/place/for/mobile',
            method: 'post',
            data: data
        }).then((result) => {
    ...
    return (
        <>
            <Container fluid>
                <h4>Add Place for Mobile Delivery</h4>
                <Form>
                    <Form.Group>
                        <Form.Label>Select the Mobile to add the Place</Form.Label>
                        <Select
                            options={options}
                            value={selectedOption}
                            onChange={handleChange}
                            isSearchable={true}
                            placeholder="Search for select a Mobile..."
                    ...
                    <Button variant="danger" className="me-3" onClick={goToMobilePlaceList}>Cancel</Button>
...
export default AddPlaceForMobile;